...
responses = {
    ...
    "age": {
        "responses": [
            "I'm just a program, so I don't have an age!,what is your age?",
        ],
        "positive_responses": [
    ...
    "hobbies": {
        "responses": [
            "I don't have hobbies! I am always here to chat and learn,What do you enjoy doing in your free time?",
            "As a chatbot,my main hobby is helping you! How do you usually spend your leisure time?",
        ],
        "positive_responses": [
